    ...
    <div class="main-wrapper light-overscroll luoym">
        <section class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>智慧书架</el-breadcrumb-item>
            </el-breadcrumb>
        </section>
        ...
        <section class="search clearfix">
            ...
            <div class="button-blank">
                ...
                <el-button type="primary" size="small" class="btn-add" icon="plus" @click.native="handleAdd" v-if="role == 2">导入新书架</el-button>
            </div>
        </section>
        ...
        <section class="table">
            ...
            <el-table :data="tableData" stripe tooltip-effect="dark" style="width: 100%" v-loading="tableloading">
                ...
                <el-table-column label="书架设备号">
                    <template scope="scope">{{ scope.row.code }}</template>
                </el-table-column>
                <el-table-column label="书架设备名">
        ...
        <el-dialog title="导入新书架" :visible.sync="addDialogShow" :modal-append-to-body="false">
            <section class="formation">
                ...
                <el-form label-position="right" :rules="addRules" ref="addRuleForm" label-width="180px" :model="addDialogInfo">
                    ...
                    <el-form-item label="书架版本" prop="version">
        ...
        <el-dialog title="编辑书架信息" :visible.sync="editDialogShow" :modal-append-to-body="false" class="editDialog-wrapper">
            <section class="formation">
               
                <el-form label-position="right" :rules="editRules" ref="editRuleForm" label-width="180px" :model="editDialogInfo">
                    <div class="flex-h">
                        <div class="flex-a-i">
                            <div style="font-size: 14px; line-height: 2; color: #333; padding: 10px 0 20px 0;">智慧书架基本信息</div>
                            <div class="">
                                <el-form-item label="书架设备号">
                        ...
                        <div class="flex-a-i">
                            <div style="font-size: 14px; line-height: 2; color: #333; padding: 10px 0 20px 0;">智慧书架应用信息</div>
                            <div class="">
                                <el-form-item label="书架设备名">
        ...
        <el-dialog title="导入书架应用信息" :visible.sync="applicationDialogShow" :modal-append-to-body="false">
            <section class="formation">
...
<script>
    ...
    import { uploadPath, channelList, getAllSmartDeviceVersion, getSchoolListByChannel, smartBookshelfList, smartBookshelfSave, getClassListBySchool, getRegionListBySchool } from '../api/api';
    ...
    export default {
        data() {
            return {
                ...
                // 激活新设备
                uploadLoading: false,
                uploadUrl: uploadPath + '/ajax/bookshelf/import/activate',
                fileList: [],
                ...
                uploadApplicationUrl: uploadPath + '/ajax/bookshelf/import/applicationInfo',
                applicationFileList: [],
        ...
        methods: {
            ...
            getList: function() {
                ...
                smartBookshelfList(param).then(res => {
            ...
            submitEdit: function(formName) {
                ...
                this.$refs[formName].validate((valid)=>{
                    if(valid){
                        ...
                        smartBookshelfSave(params).then(res=>{
                            let { errorInfo, code, data } = res;
            ...
            handleDownloadActivate: function() {
                location.href = uploadPath + '/ajax/bookshelf/import/template?type=1';
            },   
            // 下载录入模板
            handleDownloadApplication: function() {
                location.href = uploadPath + '/ajax/bookshelf/import/template?type=2';
            },
            ...
            handleExportSubmit: function() {
                ...
                location.href = uploadPath + '/ajax/bookshelf/export?exportContent=' + exportContent + '&versionIds=' + versionIds + '&channelIds=' + channelIds + '&saleType=' + saleType + '&status=' + status + '&schoolIds=' + schoolIds;
            }
        },
        mounted() {
            that = this;
