    ...
    <div class="main-wrapper light-overscroll luoym machine-version">
        <section class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>智慧接收器版本</el-breadcrumb-item>
            </el-breadcrumb>
        </section>
        ...
        <el-dialog :title="editInfo.id ? '编辑智慧接收器版本' : '新增智慧接收器版本'" :visible.sync="editDialogShow" :modal-append-to-body="false" custom-class="w700">
