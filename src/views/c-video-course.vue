            ...
            <div class="main-wrapper light-overscroll luoym">
                <section class="crumbs">
                    <el-breadcrumb separator="/">
                        <el-breadcrumb-item>课程记录</el-breadcrumb-item>
                    </el-breadcrumb>
                </section>
                ...
                <section class="table">
                    <el-table :data="tableData" stripe style="width: 100%" v-loading="tableloading">
                        ...
                        <el-table-column label="上课班级/小组">
                            <template scope="scope"><p>{{ scope.row.className }}</p></template>
                        </el-table-column>
                ...
                <el-dialog title="编辑课程记录" :visible.sync="editDialogShow" :modal-append-to-body="false">
                    <section class="formation">
                        ...
                        <el-form label-position="right" label-width="180px">
                            <el-form-item label="视频">
                                ...
                                <el-button type="primary" size="small" class="btn-add button-add" icon="upload2" @click.native="handleDownloadCourse(editDialogInfo.info.id)" style="float: right; margin-right: 50px;">下载课程记录</el-button>
                            </el-form-item>
...
<script>
    ...
    import { uploadPath, courseRecordList, tagsClassifyList, tagsList, courseRecordTagUpdate } from '../api/api';
    ...
    export default {
        ...
        methods: {
            ...
            handleSaveCourse: function() {
                ...
                courseRecordTagUpdate(params).then(res=>{
