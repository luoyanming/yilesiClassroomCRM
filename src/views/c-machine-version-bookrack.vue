    ...
    <div class="main-wrapper light-overscroll luoym machine-version">
        <section class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>智慧书架版本</el-breadcrumb-item>
            </el-breadcrumb>
        </section>
        ...
        <el-dialog :title="editInfo.id ? '编辑智慧书架版本' : '新增智慧书架版本'" :visible.sync="editDialogShow" :modal-append-to-body="false" custom-class="w700">
