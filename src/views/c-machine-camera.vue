    ...
    <div class="main-wrapper light-overscroll luoym">
        <section class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>智慧摄像头</el-breadcrumb-item>
            </el-breadcrumb>
        </section>
        ...
        <section class="search clearfix">
            ...
            <div class="button-blank clearfix">
                ...
                <el-button type="primary" size="small" class="btn-add" icon="plus" @click.native="handleAdd" v-if="role == 2">导入新摄像头</el-button>
            </div>
        </section>
        ...
        <section class="table">
            ...
            <el-table :data="tableData" stripe tooltip-effect="dark" style="width: 100%" v-loading="tableloading">
                ...
                <el-table-column label="摄像头设备号">
                    <template scope="scope">{{ scope.row.code }}</template>
                </el-table-column>
                <el-table-column label="摄像头设备名">
                ...
                <el-table-column label="镜头朝向">
                    <template scope="scope">
                        <p v-if="scope.row.turn == 0">内</p>
                        <p v-if="scope.row.turn == 1">外</p>
                    </template>
                </el-table-column>
                <el-table-column label="摄像头版本">
        ...
        <el-dialog title="导入新摄像头" :visible.sync="addDialogShow" :modal-append-to-body="false">
            <section class="formation">
                ...
                <el-form label-position="right" :rules="addRules" ref="addRuleForm" label-width="180px" :model="addDialogInfo">
                    ...
                    <el-form-item label="摄像头版本" prop="version">
        ...
        <el-dialog title="编辑摄像头信息" :visible.sync="editDialogShow" :modal-append-to-body="false" class="editDialog-wrapper">
            <section class="formation">
               
                <el-form label-position="right" :rules="editRules" ref="editRuleForm" label-width="180px" :model="editDialogInfo">
                    <div class="flex-h">
                        <div class="flex-a-i">
                            <div style="font-size: 14px; line-height: 2; color: #333; padding: 10px 0 20px 0;">智慧摄像头基本信息</div>
                            <div class="">
                        ...
                        <div class="flex-a-i">
                            <div style="font-size: 14px; line-height: 2; color: #333; padding: 10px 0 20px 0;">智慧摄像头应用信息</div>
                            <div class="">
                                <el-form-item label="摄像头设备名">
                                ...
                                <el-form-item label="镜头朝向">
                                    <el-select v-model="editDialogInfo.turn" placeholder="请选择">
                                        <el-option v-for="item in turnOptions" :key="item.value" :label="item.label" :value="item.value"></el-option>
                                    </el-select>
                                </el-form-item>
                            </div>
                        </div>
        ...
        <el-dialog title="导入摄像头应用信息" :visible.sync="applicationDialogShow" :modal-append-to-body="false">
            <section class="formation">
...
<script>
    ...
    import { uploadPath, channelList, getAllSmartDeviceVersion, getSchoolListByChannel, smartCameraList, smartCameraSave, getClassListBySchool, getRegionListBySchool } from '../api/api';
    ...
    export default {
        data() {
            return {
                ...
                // 激活新设备
                uploadLoading: false,
                uploadUrl: uploadPath + '/ajax/camera/import/activate',
                fileList: [],
                ...
                uploadApplicationUrl: uploadPath + '/ajax/camera/import/applicationInfo',
                applicationFileList: [],
        ...
        methods: {
            ...
            getList: function() {
                ...
                smartCameraList(param).then(res => {
            ...
            handleEdit: function(index, row) {
                ...
                setTimeout(function() {
                    ...
                    that.editDialogInfo.turn = '' + row.turn;
                ...
                this.$refs[formName].validate((valid)=>{
                    if(valid){
                        ...
                        let params = {
                            ...
                            'turn': this.editDialogInfo.turn
                        };

                        smartCameraSave(params).then(res=>{
                            let { errorInfo, code, data } = res;
            ...
            handleDownloadActivate: function() {
                location.href = uploadPath + '/ajax/camera/import/template?type=1';
            },   
            // 下载录入模板
            handleDownloadApplication: function() {
                location.href = uploadPath + '/ajax/camera/import/template?type=2';
            },
            ...
            handleExportSubmit: function() {
                ...
                location.href = uploadPath + '/ajax/camera/export?exportContent=' + exportContent + '&versionIds=' + versionIds + '&channelIds=' + channelIds + '&saleType=' + saleType + '&status=' + status + '&schoolIds=' + schoolIds;
            }
        },
        mounted() {
            that = this;
