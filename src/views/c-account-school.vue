    ...
    <div class="main-wrapper light-overscroll luoym account-admin">
        <section class="crumbs clearfix">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>学校账户管理</el-breadcrumb-item>
            </el-breadcrumb>
        ...
        <section class="table" style="height: auto;">
            <el-table :data="tableData" stripe style="width: 100%" v-loading="tableloading">
                <el-table-column label="学校">
                    <template scope="scope"><p>{{ scope.row.schoolName }}</p></template>
                </el-table-column>
        ...
        <el-dialog :title="editDialogInfo.id ? '编辑学校账户' : '创建学校账户'" :visible.sync="editDialogShow" :modal-append-to-body="false" custom-class="w800 height-auto" @close="handleEditDialogClose">
            <section class="formation">
               
                <el-form label-position="right" :rules="rules" ref="editDialogInfo" label-width="180px" :model="editDialogInfo">
                    <el-form-item label="学校">
                        <el-select placeholder="请选择渠道" v-model="editDialogInfo.channelId" :disabled="editDialogInfo.id ? true : false" @change="handleChannelChange">
                            <el-option v-for="item in channelOptions" :key="item.id" :label="item.name" :value="item.id"></el-option>
                        </el-select>
                        <el-select placeholder="请选择学校" v-model="editDialogInfo.schoolId" :disabled="editDialogInfo.id ? true : false">
...
<script>
    ...
    import { channelSchoolUserList, channelSchoolUserSave, channelSchoolUserDelete, adminUserMemberList, channelList, channelSchoolSchoolList } from '../api/api';
    ...
    export default {
        ...
        methods: {
            ...
            handleChannelChange: function() {
                let param = {
                    id: this.editDialogInfo.channelId
                };

                channelSchoolSchoolList(param).then(res => {
                    let { errorInfo, code, data } = res;
            ...
            handleEdit: function(index, row) {
                if(!row) { //add
                    ...
                    this.editDialogInfo.schoolId = '' + row.schoolId;
            ...
            editDialogSubmit: function(formName) {
                ...
                if(!this.editDialogInfo.channelId) {
                    this.$message({ message: '请选择渠道', type: 'error' });
                    return false;
                }
                if(!this.editDialogInfo.schoolId) {
                ...
                this.$refs[formName].validate((valid)=>{
                     if(valid){
                        ...
                        let content = {
                            ...
                            schoolId: this.editDialogInfo.schoolId,
